...
module.exports = class extends Base {
  ...
  indexAction() {
    ...
    result.almanac = {
      ...
      xunkong: { // 旬空
        year: lunarInstance.getYearXunKong(),
        month: lunarInstance.getMonthXunKong(),
        day: lunarInstance.getDayXunKong()
      },
      shiershen: lunarInstance.getZhiXing() + '执神', // 建除十二执星
      yuexiang: lunarInstance.getYueXiang() + '月', // 月相
      jiuxing: { // 九星
        year: lunarInstance.getYearNineStar().toString(),
        month: lunarInstance.getMonthNineStar().toString(),
        day: lunarInstance.getDayNineStar().toString(),
        time: lunarInstance.getTimeNineStar().toString()
      },
