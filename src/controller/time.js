...
module.exports = class extends Base {
  constructor(...arg) {
    ...
    // 数字转中文速查表
    this.numberStr = ['日', '一', '二', '三', '四', '五', '六', '七', '八', '九', '十'];
    // 日期转农历称呼速查表
  ...
  indexAction() {
    return this.success(this.getCalendar());
  }
  ...
  */
  ...
  /**
    ...
    */
  getCalendar(y, m, d) { // 参数区间1900.1.31~2100.12.31
    // 年份限定、上限
    if (y < 1900 || y > 2100) {
  ...
  lunar2solar(y, m, d, isLeapMonth) { // 参数区间1900.1.31~2100.12.1
    ...
    return this.getCalendar(cY, cM, cD);
  }
};
